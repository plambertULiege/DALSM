#' Object resulting from the fit of a constrained density on potentially right- or interval-censored data.
#'
#' @description An object returned by the \code{\link{densityGivenMeanVariance}} function: this is a list
#' with various components related to the fit of a constrained density on potentially right- or interval-censored data.
#'
#' @return A {\link{densityGivenMeanVariance}} object has the following elements:
#' Essential part:
#' \itemize{
...
#' \item{\code{est} : \verb{ }}{vector containing the estimated/selected (\eqn{\phi,\log\tau})}
...
#' \item{\code{method} : \verb{ }}{method used for penaly selection: "evidence" (by maximizing the marginal posterior for <tau>) or "Schall" (Schall's method)}
...
#' }
#' Additional elements:
#' the content of the \link{Dens1d.object} used to call \link{densityGivenMeanVariance}.
#'
...
#'
#' @seealso \code{\link{densityGivenMeanVariance}}, \code{\link{DALSM}}
#'
#' @name densityGivenMeanVariance.object
NULL
