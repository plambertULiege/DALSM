...
print.densLPS = function(x,...){
  ...
  cat("-----------------------------------------------------------------------\n")
  cat("INPUT:\n")
  cat("  Total weighted sample size: ",fit$sw,"\n")
  cat("  Uncensored data: ",fit$n.uncensored," (",round(100*fit$n.uncensored/fit$sw,2)," percents)\n",sep="")
  cat("  Interval-censored (IC) data: ",fit$n.IC," (",round(100*sum(fit$n.IC)/fit$sw,2)," percents)\n",sep="")
  cat("  Right-censored (RC) data: ",fit$n.RC," (",round(100*fit$n.RC/fit$sw,2)," percents)\n",sep="")
  cat("  ---\n")
