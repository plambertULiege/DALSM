#' Object generated by function \code{densityIC}
#'
#' @description An object returned by function \code{\link{densityIC}}: this is a list
#' with various components related to the estimation of a density with given mean and variance from potentially right- or interval-censored data.
#'
#' @return An object returned by \code{\link{densityIC}} has the following elements:
#' Essential part:
#' \itemize{
...
#' }
#' Additional elements:
#' the content of the \link{Dens1d.object} used when \link{densityIC} was called.
#'
...
#'
#' @seealso \code{\link{densityIC}}, \code{\link{DALSM}}
#'
#' @name densIC.object
NULL
