...
#' @docType data
#'
#' @description Money available per person in 756 Belgian households (ESS 2016 ; Lambert 2021, Section 4)
...
#' \item{\code{twoincomes} : \verb{ }}{\code{1}: two-income household ; \code{0}: one-income household.}
