#' Object created by \code{Dens1d} for density estimation from censored data using \code{densityGivenMeanVariance}
#'
#' @description An object returned by the \code{Dens1d} function: this is a list with various components related to density estimation from censored data using P-splines and function \code{\link{densityGivenMeanVariance}}
#'
#' @return A \code{Dens1d} object has the following elements:
#'
#' \itemize{
...
#'
#' @seealso \code{\link{Dens1d}}, \code{\link{densityGivenMeanVariance}}
#'
#' @name Dens1d.object
NULL
