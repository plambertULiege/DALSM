...
#'
#' An object returned by the \code{\link{densityGivenMeanVariance}} function: this is a list
#' with various components related to the fit of a constrained density on potentially right- or interval-censored data.
#'
#' @return A \code{densityGivenMeanVariance} object has the following elements:
#' Essential part:
#' \itemize{
...
#' \item{\code{phi} : \verb{ }}{estimated spline parameters)}
#' \item{\code{U.phi} : \verb{ }}{score of the Lagrangian G(\phi,\omega)}
...
#' \item{\code{est}} : \verb{ }}{vector containing the estimated/selected (phi,log(tau)}
...
#' \item{\code{fixed.disp} : \verb{ }}{matrix with estimated fixed effects (est,se,ci.low,ci.up) in the dispersion sub-model}
...
#' \item{\code{bread.psi1, Sand.psi1, Cov.psi1}: \verb{ }}{estimated Variance-Covariance matrix for psi1}
#' \item{\code{U.psi1} : \verb{ }}{gradient for psi1)}
#' \item{\code{bread.psi2, Sand.psi2, Cov.psi2}: \verb{ }}{estimated Variance-Covariance matrix for psi2}
#' \item{\code{U.psi2} : \verb{ }}{gradient for psi2)}
#' \item{\code{U.psi} : \verb{ }}{gradient for psi=(psi1,psi2)}
#' \item{\code{Cov.psi} : \verb{ }}{variance-covariance for psi=(psi1,psi2)}
#' \item{\code{regr1} : \verb{ }}{object generated by \code{DesignFormula} for the specified submodel for location}
#' \item{\code{regr2} : \verb{ }}{object generated by \code{DesignFormula} for the specified submodel for dispersion}
...
#' \item{\code{xgrid} : \verb{ }}{grid on (0,1)}
#' \item{\code{cred.int} : \verb{ }}{nominal level for the reported credible intervals}
#' \item{\code{alpha} : \verb{ }}{used specified alpha with (1-alpha) confidence level credible intervals reported}
#' \item{\code{sandwich} : \verb{ }}{logical indicating if varcov and se's computed using sandwich estimator in the NP case}
...
#' \item{\code{xi1} : \verb{ }}{matrix with the selected log penalty parameters for the J1 additive terms in location (point estimate, se, ci.low, ci.up}
#' \item{\code{U.xi1} : \verb{ }}{gradient for the log of the penalty parameters for the J1 additive terms in location}
#' \item{\code{U.lambda1} : \verb{ }}{gradient for the penalty parameters for the J1 additive terms in location}
#' \item{\code{Cov.xi1} : \verb{ }}{estimated Variance-Covariance matrix for the parameters involved in the J1 additive terms in location}
#' \item{\code{lambda1.min} : \verb{ }}{minimal value for the penalty parameters in the additive submodel for location}
#' \item{\code{lambda1} : \verb{ }}{matrix with the selected penalty parameters for the J1 additive terms in location (point estimate, se, ci.low, ci.up}
#' \item{\code{ED1} : \verb{ }}{matrix with the effective dimensions for each of the J1 additive terms for location (point estimate,ci.low,ci.up)}
#' }
...
#' \item{\code{xi2} : \verb{ }}{matrix with the selected log penalty parameters for the J2 additive terms in dispersion (point estimate, se, ci.low, ci.up}
#' \item{\code{U.xi2} : \verb{ }}{gradient for the log of the penalty parameters for the J2 additive terms in dispersion}
#' \item{\code{U.lambda2} : \verb{ }}{gradient for the penalty parameters for the J2 additive terms in dispersion}
#' \item{\code{Cov.xi2} : \verb{ }}{estimated Variance-Covariance matrix for the parameters involved in the J2 additive terms in dispersion}
#' \item{\code{lambda2.min} : \verb{ }}{minimal value for the penalty parameters in the additive submodel for dispersion}
#' \item{\code{lambda2} : \verb{ }}{matrix with the selected penalty parameters for the J2 additive terms in dispersion (point estimate, se, ci.low, ci.up}
#' \item{\code{ED2} : \verb{ }}{matrix with the effective dimensions for each of the J2 additive terms for dispersion (point estimate,ci.low,ci.up)}
#' }
#'
