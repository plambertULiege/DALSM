...
[2] Lambert, P. (2021). *DALSM*: Nonparametric **D**ouble **A**dditive **L**ocation-**S**cale **M**odel - R package version 0.9.2. [https://CRAN.R-project.org/package=DALSM](https://CRAN.R-project.org/package=DALSM) ; GitHub: [https://github.com/plambertULiege/DALSM](https://github.com/plambertULiege/DALSM)
