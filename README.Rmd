...
[2] Lambert, P. (2023). *DALSM*: Nonparametric **D**ouble **A**dditive **L**ocation-**S**cale **M**odel - R package version 0.9.1. [https://CRAN.R-project.org/package=DALSM](https://CRAN.R-project.org/package=DALSM) ; GitHub: [https://github.com/plambertULiege/DALSM](https://github.com/plambertULiege/DALSM)
