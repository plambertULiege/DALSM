...
per person in the household tends to decrease with age (see $f_1^\mu(\mathrm{age})$ $f_ 1^ \mu(\mathrm{age})$) between approximately 27 and 37 (most likely due the arrival of children in the family) and to increase after 40
